...
module.exports = {
  safelist: [
    ...
    "[--button-foreground:var(--color-text-inverse)]",
    "[--button-border:var(--color-primary-500)]",
    "[--button-hover-bg:var(--color-primary-600)]",
    "[--button-hover-foreground:var(--color-text-inverse)]",
    "[--button-focus-ring:var(--color-border-focus)]",
    "[--button-disabled-bg:var(--color-border-disabled)]",
    "[--button-disabled-foreground:var(--color-text-disabled)]",
    "[--button-disabled-border:var(--color-border-disabled)]",
    "[--button-bg:var(--color-bg-secondary)]",
    "[--button-foreground:var(--color-text-primary)]",
    "[--button-border:var(--color-border-default)]",
    "[--button-hover-bg:var(--color-bg-tertiary)]",
    "[--button-hover-foreground:var(--color-text-primary)]",
    "[--button-disabled-bg:var(--color-bg-tertiary)]",
    "[--button-bg:var(--color-error-500)]",
    "[--button-border:var(--color-error-500)]",
    "[--button-hover-bg:color-mix(in_srgb,_var(--color-error-500)_90%,_transparent)]",
    "[--button-disabled-bg:var(--color-error-50)]",
    "[--button-bg:var(--color-bg-primary)]",
    "[--button-hover-bg:var(--color-bg-secondary)]",
    "[--button-disabled-bg:var(--color-bg-secondary)]",
    "[--button-bg:transparent]",
    "[--button-border:transparent]",
    "[--button-hover-bg:transparent]",
    "[--button-hover-foreground:var(--color-text-link-hover)]",
    "[--button-foreground:var(--color-text-link)]",
