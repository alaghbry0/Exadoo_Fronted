...
export const PaymentButtons = ({
  ...
  const isStarsButtonDisabled = disabled || !telegramId || loading || paymentStatus !== 'idle';
  ...
  const showUsdtSpinner = loading && (paymentStatus === 'processing_usdt' || (paymentStatus !== 'idle' && paymentStatus !== 'processing_stars')); // كن أكثر تحديدًا إذا أمكن
  const showStarsSpinner = loading && (paymentStatus === 'processing_stars' || (paymentStatus !== 'idle' && paymentStatus !== 'processing_usdt')); // كن أكثر تحديدًا إذا أمكن
