...
export const componentVariants = {
  ...
  card: {
    ...
    elevated: 'shadow-elevation-2 hover:shadow-elevation-4 transition-shadow duration-300',
    interactive: 'cursor-pointer hover:-translate-y-0.5 transition-all duration-300',
  ...
  button: {
    ...
    primary: 'bg-gradient-to-r from-primary-500 to-primary-600 text-white hover:from-primary-600 hover:to-primary-700 active:scale-95',
    secondary: 'bg-secondary-500 text-white hover:bg-secondary-600 active:scale-95',
    outline: 'border-2 border-primary-500 text-primary-500 hover:bg-primary-50 dark:hover:bg-primary-950 active:scale-95',
    ghost: 'text-primary-500 hover:bg-primary-50 dark:hover:bg-primary-950 active:scale-95',
  ...
  input: {
    ...
    default: 'border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 focus:border-primary-500 focus:ring-primary-500/20',
  ...
  alert: {
    ...
    success: 'bg-success-50 border-success-500 text-success-900 dark:bg-success-950 dark:text-success-100',
    warning: 'bg-warning-50 border-warning-500 text-warning-900 dark:bg-warning-950 dark:text-warning-100',
    error: 'bg-error-50 border-error-500 text-error-900 dark:bg-error-950 dark:text-error-100',
  },
...
export function mergeVariants(...variants: (string | undefined | false)[]): string {
