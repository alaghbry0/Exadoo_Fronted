...
import { useTelegram } from "@/shared/context/TelegramContext"; // تأكد من المسار
import { sseService } from "@/domains/notifications/services/sseService"; // استيراد الخدمة الجديدة
