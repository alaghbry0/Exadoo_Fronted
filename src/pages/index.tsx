...
import { TonConnectButton, TonConnectUIProvider } from '@tonconnect/ui-react'; // استيراد TonConnectUIProvider
...
const Home: React.FC = () => {
    ...
    return (
                    ...
                    <div className="container mx-auto px-111 text-center relative z-10">
                        ...
                        >
                            <TonConnectButton
                                ...
                                className={`px-8 py-3 bg-white text-[#2d3748] shadow-md
                                rounded-full text-lg sm:text-xl font-bold flex items-center gap-2 hover:shadow-lg
                                transition-all active:scale-95 motion-safe:hover:scale-103 motion-safe:active:scale-95`} // تمت إزالة border و border-gray-200
                            >
                                <svg className="w-5 h-5 text-[#2390f1] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        </TonConnectUIProvider> // نهاية تغليف TonConnectUIProvider
    )
}
