  ...
  ({
    ...
    <div className="mb-6 flex items-center gap-4">
      <div
        className={cn(
          componentVariants.card.elevated,
          "grid place-items-center w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 -500/30",
        )}
      >
...
export default function AcademyIndex() {
  ...
  return (
    <div
      dir="rtl"
      className="min-h-screen bg-white dark:bg-neutral-950 font-arabic text-gray-800 dark:text-neutral-200"
    >
            ...
            >
              <div className="relative rounded-[1.5rem] bg-white p-0.5 dark:bg-neutral-900">
                ...
                <input
                  ...
                  className={cn(
                    componentVariants.card.base,
                    "block w-full rounded-[1.35rem] py-3.5 pr-4 pl-12 text-base text-gray-900 placeholder:text-gray-400 focus: focus:outline-none focus:ring-4 focus:ring-primary-400/10 dark:text-neutral-100 dark:placeholder:text-neutral-500 dark:focus:",
                  )}
