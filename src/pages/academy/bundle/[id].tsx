...
export default function BundleDetail() {
  ...
  if (isError) return <EmptyState icon={Package} title="تعذّر التحميل" description={(error as Error)?.message} />

  if (!bundle && !isLoading) return <EmptyState icon={Package} title="لم يتم العثور على الحزمة" description="عذرًا، الحزمة المطلوبة غير متوفرة" />
